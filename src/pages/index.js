    ...
    <main className='max-w-4xl  md:w-[95%] mx-auto mt-9 md:mt-20 md:flex md:flex-row-reverse items-center'>
       <motion.article
        ...
        className='md:max-w-1/2  '>
         ...
         >
          <h1 className='font-medium text-[2.6rem] sm:text-[90px] sm:font-bold'>Hello</h1>
          <p className='font-semibold text-xl sm:text-2xl mt-3 sm:mt-16'>A Web Developer😉</p>
       ...
       <motion.article
          ...
          className='md:w-1/2 '>
             <img src="/myp.png" alt='bankole' className="img shadow-xl h-[21rem] w-[21rem] rounded-full mx-auto my-6 bm"/>
       </motion.article>
    </main>
  )
}
