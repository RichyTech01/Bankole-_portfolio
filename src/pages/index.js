...
<main className='max-w-[59rem] mx-auto my-10 md:my-36 md:flex md:flex-row-reverse items-center justify-between'>
  <motion.article className='md:max-w-[48%] md:w-[46%] max-w-[30rem] w-[95%] mx-auto'>
      ...
      >
        ...
        <p className='mt-1 text-[16px] leading-7 opacity-[1] font-light'>I&apos;m a next.js developer focused on fast and user-friendly web applications. Clean code enthusiast with a passion for learning. Let's create exceptional web experiences together. </p>
      </motion.div>
