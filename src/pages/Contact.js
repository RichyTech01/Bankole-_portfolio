const Contact = () => {
    return ( 
        <div className="mt-24 max-w-5xl w-[90%] mx-auto sm:flex justify-between ">
        ...
        <form className="space-y-8 md:space-y-0 my-60 mt-8 md:flex justify-end items-center flex-wrap md:max-w-[28rem] md:w-[80%] sm:justify-between">
                ...
                <div className="rounded-full ">
                    <button className="w-24 h-24 sm:w-[8rem] sm:h-[8rem] border-black border text-base bg-amber-500 rounded-full">Submit</button>
                </div>
            </form>
        </div>
     );
